...
public class EventPopUpDialog extends PopUpUI {
     ...
     */
    public EventPopUpDialog(String illustrationSprite, Description eventDescription) {
     ...
     * @param eventDescription The event description, utilizes the descriptions.csv - use "Global.getSettings().getDescription("yourDescriptionId", Description.Type.CUSTOM)"
     */
    public EventPopUpDialog(String headerTitle, String illustrationSprite, Description eventDescription) {
...
//            AshMisc.drawRectangleFilledForTooltip(headerTooltip,fader.getBrightness(), Global.getSector().getPlayerFaction().getDarkUIColor().darker());
    ...
    public void createContentForDialog(TooltipMakerAPI tooltip, float width){
        ...
        TooltipMakerAPI textTooltip = mainPanel.createUIElement(textAreaWidth, contentMaxHeight, true);
        try {
