...
public class    ResizableComponent implements CustomUIPanelPlugin {
    ...
    public void addComponent(ResizableComponent resizableComponent, float x, float y) {
        ...
        resizableComponent.scale = this.scale;
    ...
    protected class ReflectionUtilis {
        ...
        public static UIPanelAPI getCoreUI() {
            ...
            if(AppDriver.getInstance().getCurrentState() instanceof CampaignState){
                dialog = invokeMethod("getEncounterDialog", AppDriver.getInstance().getCurrentState());
            }

            CoreUIAPI core;
            if (dialog == null) {
                core = (CoreUIAPI)invokeMethod("getCore",campaignUI);
            }
            else {
                core = (CoreUIAPI) invokeMethod( "getCoreUI",dialog);
            }
        ...
        public static UIPanelAPI getCurrentTab() {
            ...
            UIPanelAPI core = (UIPanelAPI) invokeMethod("getCurrentTab",coreUltimate);
            return core == null ? null : (UIPanelAPI) core;
        }
