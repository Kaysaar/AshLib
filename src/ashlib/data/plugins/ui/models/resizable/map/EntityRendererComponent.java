...
public class EntityRendererComponent  extends MapEntityComponent{
    String stationSpec;
    ...
    public EntityRendererComponent(String stationSpec, float radius, SectorEntityToken token) {
        super(token);
        this.stationSpec = stationSpec;
        this.radius = radius;
        componentPanel = Global.getSettings().createCustom(radius * 2f, radius * 2f, this);
    }
    public EntityRendererComponent(String spriteName, float width, float height, float radius, float facing,SectorEntityToken token) {
        super(token);
    ...
    public EntityRendererComponent(ShipVariantAPI var, float radius, float facing,SectorEntityToken token) {
        super(token);
        this.viewMember = var;
        this.radius = radius;
        componentPanel = Global.getSettings().createCustom(radius * 2f, radius * 2f, this);
