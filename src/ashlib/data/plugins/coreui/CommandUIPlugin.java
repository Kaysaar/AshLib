...
public class CommandUIPlugin implements ExtendedUIPanelPlugin {
   ...
   public CustomPanelAPI mainPanel;
    ...
    public CustomPanelAPI panelForPlugins = null;
    public CustomPanelAPI buttonPanel = null;
    public  boolean pausedMusic = true;

    public HashMap<ButtonAPI, CustomPanelAPI> panelMap = new HashMap<>();
    public String getTabStateId(){
        return "";
    }
    public CommandUIPlugin (float width,float height){
