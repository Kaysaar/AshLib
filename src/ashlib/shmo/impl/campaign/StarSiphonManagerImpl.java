...
import ashlib.shmo.api.ids.ShmoGraphics;
import ashlib.shmo.api.ids.ShmoSounds;
...
class StarSiphonManagerImpl extends BaseCustomEntityPlugin implements StarSiphonManager {
    ...
    private static final String DEFAULT_PARAMS_KEY     = "defaultParams";
    ...
    public StarSiphonParams getDefaultParams() {
        return data.getOrConstruct(DEFAULT_PARAMS_KEY, this::createDefaultParams);
    }

    @Override
    public void setDefaultParams(StarSiphonParams params) {
        data.set(DEFAULT_PARAMS_KEY, params);
    }

    @Override
    public void resetDefaultParams() {
        data.set(DEFAULT_PARAMS_KEY, createDefaultParams());
    }

    private StarSiphonParams createDefaultParams() {
